...
# Tittle
pygame.display.set_caption('Bakery Crush')
icon = pygame.image.load('croissant.png')
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load('tomato.png'))
...
# Bullet
bulletImg = pygame.image.load('pizzaslice.png')
bulletX = 0
bulletY = 480
bulletY_change = 8
bullet_state = 'ready'
